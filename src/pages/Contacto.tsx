    ...
    try {
      ...
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: `Nueva Consulta de Proyecto - ${formData.marca || formData.nombre}`,
          ...
          presupuesto: budget,
          timeline: timeline,
          como_nos_conociste: howFound,
          info_proyecto: formData.proyectoInfo,
        }),
      });
      ...
      setSubmitError('Ocurrió un error al enviar tu consulta. Por favor, intentá nuevamente.');
    } finally {
      setSubmitting(false);
    }
  }
